...
export const AntdIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Tooltip>
        <TooltipTrigger>
            <svg
            ...
            >https://www.vectorlogo.zone/logos/google_analytics/google_analytics-icon.svg
                <defs>
                    ...
                    >
                        <stop offset="0" style={{ stopColor: "#4285eb", stopOpacity: 1 }} />
                        <stop offset="1" style={{ stopColor: "#2ec7ff", stopOpacity: 1 }} />
                    </linearGradient>
                    ...
                    <linearGradient
                        ...
                        gradientTransform="matrix(94.54297 0 0 127.17188 .418 .406)"
                    >
                        <stop offset="0" style={{ stopColor: "#29cdff", stopOpacity: 1 }} />
                        <stop offset=".379" style={{ stopColor: "#148eff", stopOpacity: 1 }} />
                        <stop offset="1" style={{ stopColor: "#0a60ff", stopOpacity: 1 }} />
                    </linearGradient>
                    ...
                    >
                        <stop offset="0" style={{ stopColor: "#fa816e", stopOpacity: 1 }} />
                        <stop offset=".415" style={{ stopColor: "#f74a5c", stopOpacity: 1 }} />
                        <stop offset="1" style={{ stopColor: "#f51d2c", stopOpacity: 1 }} />
                    </linearGradient>
                    ...
                    >
                        <stop offset="0" style={{ stopColor: "#fa8e7d", stopOpacity: 1 }} />
                        <stop offset=".513" style={{ stopColor: "#f74a5c", stopOpacity: 1 }} />
                        <stop offset="1" style={{ stopColor: "#f51d2c", stopOpacity: 1 }} />
                    </linearGradient>
                </defs>
                ...
                <path
                    fill="url(#d)"
                    fillRule="evenodd"
                    d="M79.438 64.281c0-8.336-6.762-15.094-15.106-15.094-8.34 0-15.105 6.758-15.105 15.094 0 8.332 6.765 15.09 15.105 15.09 8.344 0 15.106-6.758 15.106-15.09Zm0 0"
                />
            </svg>
        </TooltipTrigger>
        <TooltipContent>
